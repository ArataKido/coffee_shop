...
class Logger(metaclass=SingletonMeta):
    def __init__(self):
        self.destinations = []
        print(f"Log destinations: {settings.log_destinations}")  # Debugging the log destinations
        log_destinations = settings.log_destinations.split(",")
        print(f"Log destinations: {log_destinations}")  # Debugging the log destinations
