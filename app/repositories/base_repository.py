...
class BaseRepository(Generic[T]):
    ...
    def __init__(self, db: Union[AsyncSession, Session], model_class: Type[T]):
        self.db = db
    ...
    async def add(self, model: T, created_by_user_id: Optional[int] = None) -> T:
    ...
    async def add_and_commit(self, model: T, created_by_user_id: Optional[int] = None) -> T:
    ...
    async def update(self, model: T, updated_by_user_id: Optional[int] = None) -> T:
    ...
    # Синхронная версия для Celery
    def update_sync(self, model: T, updated_by_user_id: Optional[int] = None) -> T:
    ...
    async def update_and_commit(self, model: T, updated_by_user_id: Optional[int] = None) -> T:
    ...
    async def soft_delete(self, model: T, deleted_by_user_id: Optional[int] = None) -> T:
    ...
    async def activate(self, model: T, deleted_by_user_id: Optional[int] = None) -> T:
    ...
    async def bulk_create(self, models: List[Dict[str, Any]], created_by_user_id: Optional[int] = None) -> List[T]:
