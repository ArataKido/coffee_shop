...
async def read_order(order_id: int, order_service: OrderService = Depends(get_order_service)):
...
async def update_order(order_id: int, order: OrderUpdate, order_service: OrderService = Depends(get_order_service)):
