...
async def get_cart_service(cart_repo: CartRepository = Depends(get_cart_repository),
                           product_repo: CartRepository = Depends(get_product_repository)) -> CartService:
...
async def get_product_service(product_repo: ProductRepository = Depends(get_product_repository),
                              category_repo: CategoryRepository = Depends(get_category_repository)) -> ProductService:
